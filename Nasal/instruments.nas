...
initialize = func {
    ...
    props.globals.getNode("/instrumentation/transponder/inputs/knob-mode", 0).setDoubleValue(0);
...
setlistener("/engines/engine[0]/rpm",func{
             interpolate("/engines/engine/oil-temperature-degf-norm",getprop("/environment/temperature-degf")+getprop("/engines/engine/oil-temperature-degf")*(getprop("/engines/engine/fuel-flow-gph")*0.037),20)});
